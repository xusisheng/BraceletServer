package com.aw.bracelet.huawei;

import java.util.HashMap;
import java.util.Map;

public enum SubCallbackTypeEnum {
     ...
     * @param desc 枚举描述。
     */
    private SubCallbackTypeEnum(String commandType, String desc, String clazz) {
    ...
    public static Map<String,String> getAllStatusCode() {
        ...
        for (SubCallbackTypeEnum status : values()) {
